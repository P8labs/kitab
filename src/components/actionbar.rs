...
pub fn TopActionBar() -> impl IntoView {
    ...
    view! {
        ...
        <div>
          <Button on:click=move |_| handle_action("min".to_string()) variant=ButtonVariant::Accent size=ButtonSize::Icon><Minus/></Button>
          <Button on:click=move |_| handle_action("max".to_string()) variant=ButtonVariant::Accent size=ButtonSize::Icon><Maximize/></Button>
          <Button on:click=move |_| handle_action("close".to_string()) variant=ButtonVariant::Accent size=ButtonSize::Icon><X/></Button>
        </div>
